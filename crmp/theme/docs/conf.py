...
project = u'crmp.theme'
copyright = u'2013, Hexagon IT'
...
htmlhelp_basename = 'crmp.themedoc'
...
latex_documents = [
  ('index', 'crmp.theme.tex', u'crmp.theme Documentation',
   u'Hexagon IT', 'manual'),
]
